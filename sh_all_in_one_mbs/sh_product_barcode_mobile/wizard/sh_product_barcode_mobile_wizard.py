...
class sh_product_barcode_mobile_wizard(models.TransientModel):
    ...
    sh_product_bm_is_cont_scan = fields.Char(string='Continuously Scan?',default = default_sh_product_bm_is_cont_scan, readonly=True)
